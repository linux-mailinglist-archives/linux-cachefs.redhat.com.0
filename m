...
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	by mail.lfdr.de (Postfix) with ESMTPS id D081D471410
	for <lists+linux-cachefs@lfdr.de>; Sat, 11 Dec 2021 14:44:51 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1639230290;
	...
	bh=96WvzUpQwosQb4enEAES9XZaPwzOY7CSWgs/mNZXTrs=;
	b=B8Nc61aUNiUkb5aM2OnqyzQOa7/SiVcMPz88+ofIEnnFYhKKlVwS9PyPxaBSQM4w5vqRet
	DzUqz5yXmMeUhF/6encOFd4762DMcu6B7/IDOCPSlWvy/66tNfoQHlurAMUVvDRm5lam8q
	gIf840+eaXeNXthtIu7nhveHaCLD4oQ=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-395-O_WqwjyDMLq0hxajScpZgQ-1; Sat, 11 Dec 2021 08:44:47 -0500
X-MC-Unique: O_WqwjyDMLq0hxajScpZgQ-1
Received: from smtp.corp.redhat.com (int-mx07.intmail.prod.int.phx2.redhat.com [10.5.11.22])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 557791853022;
	Sat, 11 Dec 2021 13:44:45 +0000 (UTC)
Received: from colo-mx.corp.redhat.com (colo-mx01.intmail.prod.int.phx2.redhat.com [10.5.11.20])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id 879B91000180;
	Sat, 11 Dec 2021 13:44:43 +0000 (UTC)
Received: from lists01.pubmisc.prod.ext.phx2.redhat.com (lists01.pubmisc.prod.ext.phx2.redhat.com [10.5.19.33])
	by colo-mx.corp.redhat.com (Postfix) with ESMTP id C9DCF1809CB8;
	Sat, 11 Dec 2021 13:44:42 +0000 (UTC)
Received: from smtp.corp.redhat.com (int-mx01.intmail.prod.int.rdu2.redhat.com
	[10.11.54.1])
	by lists01.pubmisc.prod.ext.phx2.redhat.com (8.13.8/8.13.8) with ESMTP
	id 1BBDieZA019981 for <linux-cachefs@listman.util.phx.redhat.com>;
	Sat, 11 Dec 2021 08:44:40 -0500
Received: by smtp.corp.redhat.com (Postfix)
	id 6EF03400D3CA; Sat, 11 Dec 2021 13:44:40 +0000 (UTC)
Delivered-To: linux-cachefs@redhat.com
Received: from mimecast-mx02.redhat.com
	(mimecast09.extmail.prod.ext.rdu2.redhat.com [10.11.55.25])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id 69D6E40CFD05
	for <linux-cachefs@redhat.com>; Sat, 11 Dec 2021 13:44:40 +0000 (UTC)
Received: from us-smtp-1.mimecast.com (us-smtp-2.mimecast.com [207.211.31.81])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256
	bits)) (No client certificate requested)
	by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 47B1329ABA27
	for <linux-cachefs@redhat.com>; Sat, 11 Dec 2021 13:44:40 +0000 (UTC)
Received: from mail-ed1-f70.google.com (mail-ed1-f70.google.com
	[209.85.208.70]) by relay.mimecast.com with ESMTP with STARTTLS
	(version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
	us-mta-103-Z5uMtnC-PJqEvNmgTBdZ0Q-1; Sat, 11 Dec 2021 08:44:38 -0500
X-MC-Unique: Z5uMtnC-PJqEvNmgTBdZ0Q-1
Received: by mail-ed1-f70.google.com with SMTP id
	eg20-20020a056402289400b003eb56fcf6easo10415293edb.20
	for <linux-cachefs@redhat.com>; Sat, 11 Dec 2021 05:44:38 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
	d=1e100.net; s=20210112;
	h=x-gm-message-state:mime-version:references:in-reply-to:from:date
	:message-id:subject:to:cc;
	bh=eSCfwEwsXHZvNhSrM6BaUNli9B/PkPwzQDFZER6eRAc=;
	b=
X-Gm-Message-State: AOAM532WU0iwXLRy9bWRP1qPcb3YBNr/ma9ceq8+55mvsTgDfMmXbhA6
	I763WxKJnWJI2FZN+uJl0vWbrpYRPXpdr3vOwe2Lwg5iQUplIsUiBYjkQzU7uvSsrZb3QOwih8f
	zSBsSVXATUpBmHSAd6+3QrExte/M0X7BvJuXx0A==
X-Received: by 2002:a17:906:4fc8:: with SMTP id
	i8mr31089229ejw.427.1639230277092; 
	Sat, 11 Dec 2021 05:44:37 -0800 (PST)
X-Google-Smtp-Source: ABdhPJwj/ljBbBsfCjR6x5iWW/6MS9jOT0NGpKzTeByj8AkVbcx5tGvR2NsgNn9oWu87qK8lQc0g7gRJRfLzPyXc6aE=
X-Received: by 2002:a17:906:4fc8:: with SMTP id
	i8mr31089190ejw.427.1639230276541; 
	Sat, 11 Dec 2021 05:44:36 -0800 (PST)
MIME-Version: 1.0
References: <163906878733.143852.5604115678965006622.stgit@warthog.procyon.org.uk>
	<CALF+zOnA2U6LjDTE8m2REDTMmFVnWkcBkn0ZJQRGULPUjeQW4Q@mail.gmail.com>
In-Reply-To: <CALF+zOnA2U6LjDTE8m2REDTMmFVnWkcBkn0ZJQRGULPUjeQW4Q@mail.gmail.com>
From: David Wysochanski <dwysocha@redhat.com>
Date: Sat, 11 Dec 2021 08:44:00 -0500
Message-ID: <CALF+zOnmJ0=j8pEMikpxYgLrS10gVZiXfCjBhDz9Je0Qip7wnw@mail.gmail.com>
To: David Howells <dhowells@redhat.com>
X-Scanned-By: MIMEDefang 2.84 on 10.11.54.1
X-loop: linux-cachefs@redhat.com
Cc: linux-nfs <linux-nfs@vger.kernel.org>,
	linux-cachefs <linux-cachefs@redhat.com>
Subject: Re: [Linux-cachefs] [PATCH v2 00/67] fscache, cachefiles: Rewrite
...
On Fri, Dec 10, 2021 at 1:38 PM David Wysochanski <dwysocha@redhat.com> wrote:
>
...
(Re-sending this to cut-down list of addresses since previous attempt
did not reach the lists)

Please see the UAF text below.  I'm getting this firing periodically
with NFSv3 xfstests, but it's hard to reproduce and kasan output
varies.
