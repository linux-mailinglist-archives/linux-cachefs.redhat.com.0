Return-Path: <linux-cachefs+bncBDLIXLMFVAERB67TYOYQMGQESJZWYTI@redhat.com>
X-Original-To: lists+linux-cachefs@lfdr.de
Delivered-To: lists+linux-cachefs@lfdr.de
Received: from mail-qt1-f200.google.com (mail-qt1-f200.google.com [209.85.160.200])
	by mail.lfdr.de (Postfix) with ESMTPS id 1741E8B77F8
	for <lists+linux-cachefs@lfdr.de>; Tue, 30 Apr 2024 16:02:37 +0200 (CEST)
Received: by mail-qt1-f200.google.com with SMTP id d75a77b69052e-43b06f5a946sf20151971cf.2
        for <lists+linux-cachefs@lfdr.de>; Tue, 30 Apr 2024 07:02:37 -0700 (PDT)
ARC-Seal: i=2; a=rsa-sha256; t=1714485756; cv=pass;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        h=list-unsubscribe:list-archive:list-help:list-post:list-id
         :mailing-list:precedence:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:delivered-to;
        bh=N7hw0shhIr84ytSv/iMm22cykSHawywOWH3Xx5zzhi4=;
        fh=zheCd4doo3x3gZqtypX4gLQgkFZ5S/leo0FwQTN5MDY=;
        b=;
        darn=lfdr.de
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=list-unsubscribe:list-archive:list-help:list-post
         ...
         :message-id:reply-to;
        bh=N7hw0shhIr84ytSv/iMm22cykSHawywOWH3Xx5zzhi4=;
        b=
X-Forwarded-Encrypted: i=2; AJvYcCUxjZG2AtIUaO5ckvJJeogCrYD1qFYdNL3qM8+tiE6EHnn2KTEWLeSaSuC2jlWHQO71X2+wpzm06pIKmBHiamRsHGLiIHHwmiLTct8=
X-Gm-Message-State: AOJu0YzGPEjywR80MOfCR+D3vngHq/LwCtEN6ct85fAhdz9wnDQiLs9U
	53m2Plsym2n6LJ1fpEzDq/GjXJ2DChHmAptTYqzWudSC1htJOsLBGfGiOVa01RQ=
X-Google-Smtp-Source: AGHT+IHiazTwexhZyZbdrBMdiTbV6FZGtZ3mUC6AqCwZnNnxmWeZ6Ra5HGbypHFhVTutvmOmazWAmg==
X-Received: by 2002:a05:622a:14b:b0:43a:daca:f300 with SMTP id v11-20020a05622a014b00b0043adacaf300mr7178358qtw.24.1714485755786;
        Tue, 30 Apr 2024 07:02:35 -0700 (PDT)
X-BeenThere: linux-cachefs@redhat.com
Received: by 2002:a05:622a:191f:b0:43a:4dea:1acf with SMTP id
 d75a77b69052e-43a4dea2365ls52579781cf.0.-pod-prod-01-us; Tue, 30 Apr 2024
 07:02:35 -0700 (PDT)
X-Forwarded-Encrypted: i=2; AJvYcCXpsNgarm7hfEtHa39XFYH3cYVV0T0D0WZOnxt2MM+IYeG7FRvfi7GkHSQGDqz5uPdjbGV451BCTWSuvGBEgJPFRfxhQ/n00aqnyan9aXg=
X-Received: by 2002:a05:620a:1194:b0:790:b192:3b9d with SMTP id b20-20020a05620a119400b00790b1923b9dmr10896502qkk.58.1714485754991;
        Tue, 30 Apr 2024 07:02:34 -0700 (PDT)
ARC-Seal: i=1; a=rsa-sha256; t=1714485754; cv=none;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:delivered-to;
        bh=z5qkmu9EpyTmHYNw75A+vyiBes4fc8ckryT1zOTs5ak=;
        fh=MRByWdGD0e7LCOwxmXv5cYQpukVa0xHJcjZh5lBl/ic=;
        b=;
        dara=google.com
ARC-Authentication-Results: i=1; mx.google.com;
       gateway.spf=pass (google.com: domain gapps.redhat.com configured 170.10.128.131 as internal address) smtp.mailfrom=dhowells@redhat.com smtp.remote-ip=170.10.128.131 policy.d=gapps.redhat.com
Received: from us-smtp-inbound-delivery-1.mimecast.com (us-smtp-delivery-1.mimecast.com. [170.10.128.131])
        by mx.google.com with ESMTPS id br18-20020a05620a461200b00790988f1978si14436644qkb.528.2024.04.30.07.02.34
...
Received: from mimecast-mx02.redhat.com (mx-ext.redhat.com [66.187.233.73])
 ...
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-55-XXS2HEXhMPSC2uO5r_z8zw-1; Tue,
 30 Apr 2024 10:02:33 -0400
X-MC-Unique: XXS2HEXhMPSC2uO5r_z8zw-1
Received: from smtp.corp.redhat.com (int-mx09.intmail.prod.int.rdu2.redhat.com [10.11.54.9])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 3BD44382C46D
	for <linux-cachefs@gapps.redhat.com>; Tue, 30 Apr 2024 14:02:27 +0000 (UTC)
Received: by smtp.corp.redhat.com (Postfix)
	id 38B1640BB4E; Tue, 30 Apr 2024 14:02:27 +0000 (UTC)
Delivered-To: linux-cachefs@redhat.com
Received: from warthog.procyon.org.com (unknown [10.42.28.22])
	by smtp.corp.redhat.com (Postfix) with ESMTP id 57FD440ED31;
	Tue, 30 Apr 2024 14:02:21 +0000 (UTC)
...
Subject: [PATCH v2 19/22] netfs: Cut over to using new writeback code
Date: Tue, 30 Apr 2024 15:00:50 +0100
Message-ID: <20240430140056.261997-20-dhowells@redhat.com>
...
index 33ea4c20e7e7..d4a9a18472b7 100644
...
@@ -382,23 +390,16 @@ ssize_t netfs_perform_write(struct kiocb *iocb, struct iov_iter *iter,
...
@@ -407,7 +408,7 @@ ssize_t netfs_perform_write(struct kiocb *iocb, struct iov_iter *iter,
...
+		ret2 = netfs_end_writethrough(wreq, &wbc, writethrough);
 		...
 		if (ret2 == -EIOCBQUEUED)
 			return ret2;
@@ -529,11 +530,13 @@ vm_fault_t netfs_page_mkwrite(struct vm_fault *vmf, struct netfs_group *netfs_gr
...
@@ -573,6 +576,7 @@ vm_fault_t netfs_page_mkwrite(struct vm_fault *vmf, struct netfs_group *netfs_gr
 }
...
+#if 0 // TODO: Remove
  ...
  */
@@ -1199,3 +1203,4 @@ int netfs_writepages(struct address_space *mapping,
 	return ret;
 }
 EXPORT_SYMBOL(netfs_writepages);
+#endif
diff --git a/fs/netfs/direct_write.c b/fs/netfs/direct_write.c
index 36b6db504500..608ba6416919 100644
...
index 11b62e6f82fa..69c50f4cbf41 100644
...
@@ -577,9 +577,9 @@ struct netfs_io_request *new_netfs_begin_writethrough(struct kiocb *iocb, size_t
...
@@ -609,8 +609,8 @@ int new_netfs_advance_writethrough(struct netfs_io_request *wreq, struct writeba
 /*
