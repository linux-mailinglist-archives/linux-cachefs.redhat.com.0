...
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	by mail.lfdr.de (Postfix) with ESMTPS id EED2F4ED8F4
	for <lists+linux-cachefs@lfdr.de>; Thu, 31 Mar 2022 13:58:57 +0200 (CEST)
Received: from mimecast-mx02.redhat.com (mimecast-mx02.redhat.com
 [66.187.233.88]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-57-WB-DVcUTNqOs1yyLBN7tVg-1; Thu, 31 Mar 2022 07:58:54 -0400
X-MC-Unique: WB-DVcUTNqOs1yyLBN7tVg-1
Received: from smtp.corp.redhat.com (int-mx09.intmail.prod.int.rdu2.redhat.com [10.11.54.9])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 5FDB3804197;
	Thu, 31 Mar 2022 11:58:34 +0000 (UTC)
Received: from mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com [10.30.29.100])
	by smtp.corp.redhat.com (Postfix) with ESMTP id 631A55B2C7F;
	Thu, 31 Mar 2022 11:58:21 +0000 (UTC)
Received: from mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (localhost [IPv6:::1])
	by mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (Postfix) with ESMTP id 94E061940340;
...
Received: from smtp.corp.redhat.com (int-mx05.intmail.prod.int.rdu2.redhat.com
 ...
 ESMTP id 0414719451F3 for <linux-cachefs@listman.corp.redhat.com>;
 Thu, 31 Mar 2022 11:58:18 +0000 (UTC)
Received: by smtp.corp.redhat.com (Postfix)
 id B5CE453CF; Thu, 31 Mar 2022 11:58:17 +0000 (UTC)
Delivered-To: linux-cachefs@redhat.com
Received: from mimecast-mx02.redhat.com
 (mimecast04.extmail.prod.ext.rdu2.redhat.com [10.11.55.20])
 by smtp.corp.redhat.com (Postfix) with ESMTPS id B04D47ADA
 for <linux-cachefs@redhat.com>; Thu, 31 Mar 2022 11:58:07 +0000 (UTC)
Received: from us-smtp-1.mimecast.com (us-smtp-delivery-1.mimecast.com
 [205.139.110.120])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 78C6510115F7
 for <linux-cachefs@redhat.com>; Thu, 31 Mar 2022 11:58:07 +0000 (UTC)
Received: from out30-56.freemail.mail.aliyun.com
 (out30-56.freemail.mail.aliyun.com [115.124.30.56]) by relay.mimecast.com
 with ESMTP with STARTTLS (version=TLSv1.2,
 cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-202-X6KtXLzwPJWRxNNUHmmxBg-1; Thu, 31 Mar 2022 07:58:05 -0400
X-MC-Unique: X6KtXLzwPJWRxNNUHmmxBg-1
X-Alimail-AntiSpam: AC=PASS; BC=-1|-1; BR=01201311R251e4; CH=green; DM=||false|;
 ...
 NM=1; PH=DS; RN=18; SR=0; TI=SMTPD_---0V8imrom_1648727874
Received: from localhost(mailfrom:jefflexu@linux.alibaba.com
 fp:SMTPD_---0V8imrom_1648727874) by smtp.aliyun-inc.com(127.0.0.1);
 Thu, 31 Mar 2022 19:57:55 +0800
From: Jeffle Xu <jefflexu@linux.alibaba.com>
To: dhowells@redhat.com, linux-cachefs@redhat.com, xiang@kernel.org,
 chao@kernel.org, linux-erofs@lists.ozlabs.org
Date: Thu, 31 Mar 2022 19:57:35 +0800
Message-Id: <20220331115753.89431-2-jefflexu@linux.alibaba.com>
...
Subject: [Linux-cachefs] [PATCH v7 01/19] cachefiles: extract write routine
...
+				  term_func, term_func_priv);
 ...
 /*
@@ -484,13 +493,12 @@ static enum netfs_read_source cachefiles_prepare_read(struct netfs_read_subreque
 /*
