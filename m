...
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	by mail.lfdr.de (Postfix) with ESMTPS id 27EE37C89F3
	for <lists+linux-cachefs@lfdr.de>; Fri, 13 Oct 2023 18:07:42 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1697213261;
	...
	bh=akMIKN5dDhPRpF24Mse8TcFBWzhMN8ZZjq4qO/K2EU8=;
	b=M6xoT3pnfVMgiwVCfauA29ci0JN5ysMHakPJVblT8IJK7peqZktpJA97jkmB93NUCsmvhG
	zIXaXesVA3QuFYXlyGMfsxipcKgPzjliWf8NVW5yK6FxlQAm+PaPwmW24Vj3JvhtSNWBXD
	GBsV1nMMAQxRrrLx46L6fUZO+fHH2oU=
Received: from mimecast-mx02.redhat.com (mimecast-mx02.redhat.com
 [66.187.233.88]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-57-1fAd4_AANEmngWrGA9nRUA-1; Fri, 13 Oct 2023 12:07:38 -0400
X-MC-Unique: 1fAd4_AANEmngWrGA9nRUA-1
Received: from smtp.corp.redhat.com (int-mx01.intmail.prod.int.rdu2.redhat.com [10.11.54.1])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 5E8811029F46;
	Fri, 13 Oct 2023 16:07:37 +0000 (UTC)
Received: from mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com [10.30.29.100])
	by smtp.corp.redhat.com (Postfix) with ESMTP id 524B325C0;
	Fri, 13 Oct 2023 16:07:37 +0000 (UTC)
Received: from mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (localhost [IPv6:::1])
	by mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (Postfix) with ESMTP id 200481946589;
	Fri, 13 Oct 2023 16:07:37 +0000 (UTC)
...
Received: from smtp.corp.redhat.com (int-mx07.intmail.prod.int.rdu2.redhat.com
 ...
 ESMTP id 798C51946586 for <linux-cachefs@listman.corp.redhat.com>;
 Fri, 13 Oct 2023 16:07:35 +0000 (UTC)
Received: by smtp.corp.redhat.com (Postfix)
 id 685B01C06536; Fri, 13 Oct 2023 16:07:35 +0000 (UTC)
Delivered-To: linux-cachefs@redhat.com
Received: from warthog.procyon.org.uk (unknown [10.42.28.226])
 by smtp.corp.redhat.com (Postfix) with ESMTP id 5CA9A1C060DF;
 Fri, 13 Oct 2023 16:07:32 +0000 (UTC)
From: David Howells <dhowells@redhat.com>
To: Jeff Layton <jlayton@kernel.org>,
	Steve French <smfrench@gmail.com>
Date: Fri, 13 Oct 2023 17:04:22 +0100
Message-ID: <20231013160423.2218093-54-dhowells@redhat.com>
In-Reply-To: <20231013160423.2218093-1-dhowells@redhat.com>
References: <20231013160423.2218093-1-dhowells@redhat.com>
MIME-Version: 1.0
X-Scanned-By: MIMEDefang 3.4.1 on 10.11.54.7
Subject: [Linux-cachefs] [RFC PATCH 53/53] cifs: Remove some code that's no
 longer used, part 3
...
-
 ...
 {
@@ -3252,450 +2788,6 @@ cifs_strict_writev(struct kiocb *iocb, struct iov_iter *from)
 	return written;
 }
...
-
 ...
 {
 	ssize_t rc;
@@ -3794,101 +2886,6 @@ cifs_strict_readv(struct kiocb *iocb, struct iov_iter *to)
 	return rc;
 }
