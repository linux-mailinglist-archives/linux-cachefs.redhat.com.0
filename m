...
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	by mail.lfdr.de (Postfix) with ESMTPS id A1E03602370
	for <lists+linux-cachefs@lfdr.de>; Tue, 18 Oct 2022 06:40:46 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1666068045;
	h=from:from:sender:sender:reply-to:subject:subject:date:date:
	 message-id:message-id:to:to:cc:cc:mime-version:mime-version:
	 content-type:content-type:in-reply-to:in-reply-to:
	 references:references:list-id:list-help:list-unsubscribe:
	 list-subscribe:list-post; bh=asD7orEF7ekNSY/pj/ecCSkSnC8aE+L+hG3rRq44TaQ=;
	b=bvAhz2ZZxiKrvGAY6ICJfFxF7nED7BbPs/rqXarAtSqZ2/B883V9ltUGuWDxeaA9wJOzgb
	/JtJ+IKGE/kgv207mRH41NLTZyxszO5i+4aIAx94qwPyjeBByofbIHXrzu4juNmjPIxaSV
	vUrP1hsjZVsAFtocNcU4zXqgJq6pzjQ=
Received: from mimecast-mx02.redhat.com (mimecast-mx02.redhat.com
 [66.187.233.88]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-155-nKhWKh4VNnmSSkJXk9ORLw-1; Tue, 18 Oct 2022 00:40:39 -0400
X-MC-Unique: nKhWKh4VNnmSSkJXk9ORLw-1
Received: from smtp.corp.redhat.com (int-mx05.intmail.prod.int.rdu2.redhat.com [10.11.54.5])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by mimecast-mx02.redhat.com (Postfix) with ESMTPS id E49BD85A583;
	Tue, 18 Oct 2022 04:40:38 +0000 (UTC)
Received: from mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (unknown [10.30.29.100])
	by smtp.corp.redhat.com (Postfix) with ESMTP id D462617585;
	Tue, 18 Oct 2022 04:40:34 +0000 (UTC)
Received: from mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (localhost [IPv6:::1])
	by mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (Postfix) with ESMTP id 2CEC71946597;
	Tue, 18 Oct 2022 04:40:34 +0000 (UTC)
...
Received: from smtp.corp.redhat.com (int-mx08.intmail.prod.int.rdu2.redhat.com
 ...
 ESMTP id 41593194658F for <linux-cachefs@listman.corp.redhat.com>;
 Tue, 18 Oct 2022 04:40:33 +0000 (UTC)
Received: by smtp.corp.redhat.com (Postfix)
 id 31CAAC23F6C; Tue, 18 Oct 2022 04:40:33 +0000 (UTC)
Delivered-To: linux-cachefs@redhat.com
Received: from mimecast-mx02.redhat.com
 (mimecast09.extmail.prod.ext.rdu2.redhat.com [10.11.55.25])
 by smtp.corp.redhat.com (Postfix) with ESMTPS id 23E42C23F6B
 for <linux-cachefs@redhat.com>; Tue, 18 Oct 2022 04:40:33 +0000 (UTC)
Received: from us-smtp-1.mimecast.com (us-smtp-2.mimecast.com [205.139.110.61])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by mimecast-mx02.redhat.com (Postfix) with ESMTPS id D2C62299E766
 for <linux-cachefs@redhat.com>; Tue, 18 Oct 2022 04:40:32 +0000 (UTC)
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93]) by
 relay.mimecast.com with ESMTP with STARTTLS (version=TLSv1.2,
 cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-614-YD-luzWHNh2_rY7H1LVDrA-1; Tue, 18 Oct 2022 00:40:27 -0400
X-MC-Unique: YD-luzWHNh2_rY7H1LVDrA-1
X-IronPort-AV: E=McAfee;i="6500,9779,10503"; a="303607489"
X-IronPort-AV: E=Sophos;i="5.95,193,1661842800"; d="scan'208";a="303607489"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Oct 2022 21:39:22 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10503"; a="623470884"
X-IronPort-AV: E=Sophos;i="5.95,193,1661842800"; d="scan'208";a="623470884"
Received: from lkp-server01.sh.intel.com (HELO 8381f64adc98) ([10.239.97.150])
 by orsmga007.jf.intel.com with ESMTP; 17 Oct 2022 21:39:18 -0700
Received: from kbuild by 8381f64adc98 with local (Exim 4.96)
 (envelope-from <lkp@intel.com>) id 1okeNq-0001JQ-0h;
 Tue, 18 Oct 2022 04:39:18 +0000
Date: Tue, 18 Oct 2022 12:39:14 +0800
From: kernel test robot <lkp@intel.com>
To: Dave Wysochanski <dwysocha@redhat.com>,
 Anna Schumaker <anna.schumaker@netapp.com>,
 Trond Myklebust <trond.myklebust@hammerspace.com>,
 David Howells <dhowells@redhat.com>
Message-ID: <202210181213.tJHgSDnY-lkp@intel.com>
References: <20221017105212.77588-2-dwysocha@redhat.com>
MIME-Version: 1.0
...
Content-Type: multipart/mixed; boundary="UJ4tUkLMnY7Kds/x"
...
url:    https://github.com/intel-lab-lkp/linux/commits/Dave-Wysochanski/Convert-NFS-with-fscache-to-the-netfs-API/20221017-185437
base:   git://git.linux-nfs.org/projects/trondmy/linux-nfs.git linux-next
patch link:    https://lore.kernel.org/r/20221017105212.77588-2-dwysocha%40redhat.com
patch subject: [PATCH v9 1/5] NFS: Rename readpage_async_filler to nfs_pageio_add_page
config: m68k-allyesconfig
compiler: m68k-linux-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://github.com/intel-lab-lkp/linux/commit/8973094e9aae4baa1d5d70500498fead0e6548d9
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Dave-Wysochanski/Convert-NFS-with-fscache-to-the-netfs-API/20221017-185437
        git checkout 8973094e9aae4baa1d5d70500498fead0e6548d9
        # save the config file
        mkdir build_dir && cp config build_dir/.config
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=gcc-12.1.0 make.cross W=1 O=build_dir ARCH=m68k SHELL=/bin/bash fs/nfs/
...
>> fs/nfs/read.c:281:1: warning: no previous prototype for 'nfs_pageio_add_page' [-Wmissing-prototypes]
     281 | nfs_pageio_add_page(struct nfs_pageio_descriptor *pgio,
         | ^~~~~~~~~~~~~~~~~~~


vim +/nfs_pageio_add_page +281 fs/nfs/read.c
 ...
 > 281	nfs_pageio_add_page(struct nfs_pageio_descriptor *pgio,
   ...
   287		struct nfs_page *new;
   288		unsigned int len, aligned_len;
   289		int error;
   290	
   ...
   294	
   295		aligned_len = min_t(unsigned int, ALIGN(len, rsize), PAGE_SIZE);
   296	
   297		if (!IS_SYNC(page->mapping->host)) {
   298			error = nfs_fscache_read_page(page->mapping->host, page);
   299			if (error == 0)
   300				goto out_unlock;
   301		}
   302	
   303		new = nfs_create_request(ctx, page, 0, aligned_len);
   304		if (IS_ERR(new))
   305			goto out_error;
   306	
   307		if (len < PAGE_SIZE)
   308			zero_user_segment(page, len, PAGE_SIZE);
   309		if (!nfs_pageio_add_request(pgio, new)) {
   310			nfs_list_remove_request(new);
   311			error = pgio->pg_error;
   312			nfs_readpage_release(new, error);
   313			goto out;
   314		}
   315		return 0;
   316	out_error:
