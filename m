...
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	by mail.lfdr.de (Postfix) with ESMTPS id 74DE97C89F1
	for <lists+linux-cachefs@lfdr.de>; Fri, 13 Oct 2023 18:07:39 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1697213258;
	...
	bh=J6P62RzzRlme008dRPkTjpsBGfTholKSHbo+mghWATk=;
	b=YL9QyprIUU17VrECPtjHuM7BU0pEEl2gQlaC/aewwHoctdRUMzqFyDBYhLiKzTV1Vpd1D3
	4CYeJLF1/d2ufLQkvsdB3jb0xj8/0u+Ops9Se+aLZo3OcVqcL5ij0kN6C9Cv48jsog6OYE
	q23vQHFNKL9kjVmSlNPvvpyGkJvGzxM=
Received: from mimecast-mx02.redhat.com (mimecast-mx02.redhat.com
 [66.187.233.88]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-584-pQEbSB6_N-iUx_2uR-NZiA-1; Fri, 13 Oct 2023 12:07:35 -0400
X-MC-Unique: pQEbSB6_N-iUx_2uR-NZiA-1
Received: from smtp.corp.redhat.com (int-mx01.intmail.prod.int.rdu2.redhat.com [10.11.54.1])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 5452888B7B9;
	Fri, 13 Oct 2023 16:07:33 +0000 (UTC)
Received: from mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com [10.30.29.100])
	by smtp.corp.redhat.com (Postfix) with ESMTP id 476C525C0;
	Fri, 13 Oct 2023 16:07:33 +0000 (UTC)
Received: from mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (localhost [IPv6:::1])
	by mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (Postfix) with ESMTP id 1157E1946589;
	Fri, 13 Oct 2023 16:07:33 +0000 (UTC)
...
Received: from smtp.corp.redhat.com (int-mx07.intmail.prod.int.rdu2.redhat.com
 ...
 ESMTP id D78E01946586 for <linux-cachefs@listman.corp.redhat.com>;
 Fri, 13 Oct 2023 16:07:31 +0000 (UTC)
Received: by smtp.corp.redhat.com (Postfix)
 id B78AF1C06536; Fri, 13 Oct 2023 16:07:31 +0000 (UTC)
Delivered-To: linux-cachefs@redhat.com
Received: from warthog.procyon.org.uk (unknown [10.42.28.226])
 by smtp.corp.redhat.com (Postfix) with ESMTP id B9EF01C060DF;
 Fri, 13 Oct 2023 16:07:28 +0000 (UTC)
From: David Howells <dhowells@redhat.com>
To: Jeff Layton <jlayton@kernel.org>,
	Steve French <smfrench@gmail.com>
Date: Fri, 13 Oct 2023 17:04:21 +0100
Message-ID: <20231013160423.2218093-53-dhowells@redhat.com>
In-Reply-To: <20231013160423.2218093-1-dhowells@redhat.com>
References: <20231013160423.2218093-1-dhowells@redhat.com>
MIME-Version: 1.0
X-Scanned-By: MIMEDefang 3.4.1 on 10.11.54.7
Subject: [Linux-cachefs] [RFC PATCH 52/53] cifs: Remove some code that's no
 longer used, part 2
...
@@ -2574,701 +2574,6 @@ cifs_get_readable_path(struct cifs_tcon *tcon, const char *name,
 	return -ENOENT;
 }
...
-
  ...
  */
@@ -4583,6 +3888,7 @@ cifs_read(struct file *file, char *read_data, size_t read_size, loff_t *offset)
 }
