...
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	by mail.lfdr.de (Postfix) with ESMTPS id 928C97C89B7
	for <lists+linux-cachefs@lfdr.de>; Fri, 13 Oct 2023 18:05:55 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	...
	bh=XiFca9lMi9Gqg8A5pAM7QXlfPkHVUGnz1BBmgfOIyQg=;
	b=gNGspJTGbJo9u5uYl1XGyGVQhit1v+vAmyJcGORWqnOmwHXezVcN8caVKLMxdQnjbLqSix
	kiPG9XplHKg5Bs6JQGDcb9t9xX+Ut3VZXaT+9/DjE1s9jFZXI6C/2F3n8VFoDJ37/nCWXC
	wPXNxweXvPfWWp1F9a2PRhE6IAyQLmE=
Received: from mimecast-mx02.redhat.com (mx-ext.redhat.com [66.187.233.73])
 by relay.mimecast.com with ESMTP with STARTTLS (version=TLSv1.2,
 cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-467-iZ7cAT8KPhCwSCuHgVBtwg-1; Fri, 13 Oct 2023 12:05:51 -0400
X-MC-Unique: iZ7cAT8KPhCwSCuHgVBtwg-1
Received: from smtp.corp.redhat.com (int-mx09.intmail.prod.int.rdu2.redhat.com [10.11.54.9])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 68CF4280D205;
	Fri, 13 Oct 2023 16:05:50 +0000 (UTC)
Received: from mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com [10.30.29.100])
	by smtp.corp.redhat.com (Postfix) with ESMTP id 5C5EF492BE1;
	Fri, 13 Oct 2023 16:05:50 +0000 (UTC)
Received: from mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (localhost [IPv6:::1])
	by mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (Postfix) with ESMTP id 17F1819465A2;
	Fri, 13 Oct 2023 16:05:50 +0000 (UTC)
...
Received: from smtp.corp.redhat.com (int-mx09.intmail.prod.int.rdu2.redhat.com
 ...
 ESMTP id A817D1946586 for <linux-cachefs@listman.corp.redhat.com>;
 Fri, 13 Oct 2023 16:05:48 +0000 (UTC)
Received: by smtp.corp.redhat.com (Postfix)
 id 70BD3492BD9; Fri, 13 Oct 2023 16:05:48 +0000 (UTC)
Delivered-To: linux-cachefs@redhat.com
Received: from warthog.procyon.org.uk (unknown [10.42.28.226])
 by smtp.corp.redhat.com (Postfix) with ESMTP id CB237492BE1;
 Fri, 13 Oct 2023 16:05:45 +0000 (UTC)
From: David Howells <dhowells@redhat.com>
To: Jeff Layton <jlayton@kernel.org>,
	Steve French <smfrench@gmail.com>
Date: Fri, 13 Oct 2023 17:03:52 +0100
Message-ID: <20231013160423.2218093-24-dhowells@redhat.com>
In-Reply-To: <20231013160423.2218093-1-dhowells@redhat.com>
References: <20231013160423.2218093-1-dhowells@redhat.com>
MIME-Version: 1.0
X-Scanned-By: MIMEDefang 3.4.1 on 10.11.54.9
Subject: [Linux-cachefs] [RFC PATCH 23/53] netfs: Dispatch write requests to
 process a writeback slice
...
@@ -87,6 +87,12 @@ static inline void netfs_see_request(struct netfs_io_request *rreq,
...
index 11a073506f98..333c1ad44598 100644
...
@@ -278,6 +279,7 @@ struct netfs_io_request {
...
+	void (*cleanup)(struct netfs_io_request *req);
 ...
 /*
@@ -302,6 +304,11 @@ struct netfs_request_ops {
...
+	void (*invalidate_cache)(struct netfs_io_request *wreq);
 ...
 /*
@@ -389,6 +396,12 @@ ssize_t netfs_extract_user_iter(struct iov_iter *orig, size_t orig_len,
