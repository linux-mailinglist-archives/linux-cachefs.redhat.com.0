...
Received: from mx1.redhat.com (mx1.redhat.com [209.132.183.28])
	by mail.lfdr.de (Postfix) with ESMTPS id D51195254E
	for <lists+linux-cachefs@lfdr.de>; Tue, 25 Jun 2019 09:52:14 +0200 (CEST)
Received: from smtp.corp.redhat.com (int-mx01.intmail.prod.int.phx2.redhat.com [10.5.11.11])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by mx1.redhat.com (Postfix) with ESMTPS id E3A2781F1B;
	Tue, 25 Jun 2019 07:52:04 +0000 (UTC)
Received: from colo-mx.corp.redhat.com (colo-mx02.intmail.prod.int.phx2.redhat.com [10.5.11.21])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id 0908A600CD;
	Tue, 25 Jun 2019 07:52:03 +0000 (UTC)
Received: from lists01.pubmisc.prod.ext.phx2.redhat.com (lists01.pubmisc.prod.ext.phx2.redhat.com [10.5.19.33])
	by colo-mx.corp.redhat.com (Postfix) with ESMTP id D590E206D2;
	Tue, 25 Jun 2019 07:51:51 +0000 (UTC)
Received: from smtp.corp.redhat.com (int-mx08.intmail.prod.int.phx2.redhat.com
	[10.5.11.23])
	by lists01.pubmisc.prod.ext.phx2.redhat.com (8.13.8/8.13.8) with ESMTP
	id x5OGrU7a012554 for <linux-cachefs@listman.util.phx.redhat.com>;
	Mon, 24 Jun 2019 12:53:31 -0400
Received: by smtp.corp.redhat.com (Postfix)
	id E1C5719722; Mon, 24 Jun 2019 16:53:30 +0000 (UTC)
Delivered-To: linux-cachefs@redhat.com
Received: from mx1.redhat.com (ext-mx06.extmail.prod.ext.phx2.redhat.com
	[10.5.110.30])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id 12A0019C6A;
	Mon, 24 Jun 2019 16:53:22 +0000 (UTC)
Received: from merlin.infradead.org (merlin.infradead.org [205.233.59.134])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by mx1.redhat.com (Postfix) with ESMTPS id 15F753B46B;
	Mon, 24 Jun 2019 16:53:08 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	bh=W/VEZbdGhUjH117MWiO4d1Ef5HTQzP6Qget39bh1OFc=;
	b=RTajwX88KgEy6Vvum/1kuLKzh6
...
X-Greylist: Sender passed SPF test, Sender IP whitelisted by DNSRBL, ACL 216
	...
	[10.5.110.30]); Mon, 24 Jun 2019 16:53:08 +0000 (UTC)
X-Greylist: inspected by milter-greylist-4.5.16 (mx1.redhat.com [10.5.110.30]);
	Mon, 24 Jun 2019 16:53:08 +0000 (UTC) for IP:'205.233.59.134'
...
X-Mailman-Approved-At: Tue, 25 Jun 2019 03:51:35 -0400
Cc: Martin Brandenburg <martin@omnibond.com>, linux-cachefs@redhat.com,
	...
	cluster-devel@redhat.com, Peter Zijlstra <peterz@infradead.org>,
...
Subject: [Linux-cachefs] [RFC][PATCH] wake_up_var() memory ordering
...
X-Greylist: Sender IP whitelisted, not delayed by milter-greylist-4.5.16 (mx1.redhat.com [10.5.110.25]); Tue, 25 Jun 2019 07:52:13 +0000 (UTC)
