...
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	by mail.lfdr.de (Postfix) with ESMTPS id 4E6C874B837
	for <lists+linux-cachefs@lfdr.de>; Fri,  7 Jul 2023 22:43:35 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1688762614;
	h=from:from:sender:sender:reply-to:subject:subject:date:date:
	 message-id:message-id:to:to:cc:cc:mime-version:mime-version:
	 content-type:content-type:in-reply-to:in-reply-to:
	 references:references:list-id:list-help:list-unsubscribe:
	 list-subscribe:list-post; bh=GQNlYnevlmCTOSZ32kLX3kFMTia9vPDbuxWwuEOCtDU=;
	b=Tg2i3wPlQffek8Wbbk/oy2QBfNZJ9QL2NjluUCO9tHoptwbreYkoHxnWHPumQly8L+0tq+
	rc5lvAZYoxnYydQz2sivATQymQzA2s1bTV9E5EaxE2x8Idc5D94eahHZ8vutXO7M9ZBZbs
	qnzFcZvyY001i6lZlCRfA2WLOpciHkg=
Received: from mimecast-mx02.redhat.com (mimecast-mx02.redhat.com
 [66.187.233.88]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-554--D5K7ly_N_C8jJWnofwy7w-1; Fri, 07 Jul 2023 16:43:27 -0400
X-MC-Unique: -D5K7ly_N_C8jJWnofwy7w-1
Received: from smtp.corp.redhat.com (int-mx01.intmail.prod.int.rdu2.redhat.com [10.11.54.1])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by mimecast-mx02.redhat.com (Postfix) with ESMTPS id F00D8101A529;
	Fri,  7 Jul 2023 20:43:26 +0000 (UTC)
Received: from mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (unknown [10.30.29.100])
	by smtp.corp.redhat.com (Postfix) with ESMTP id 9494940C2070;
	Fri,  7 Jul 2023 20:43:24 +0000 (UTC)
Received: from mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (localhost [IPv6:::1])
	by mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (Postfix) with ESMTP id DC6471946A71;
...
Received: from smtp.corp.redhat.com (int-mx08.intmail.prod.int.rdu2.redhat.com
 ...
 ESMTP id 21F571946A54 for <linux-cachefs@listman.corp.redhat.com>;
 Fri,  7 Jul 2023 16:39:17 +0000 (UTC)
Received: by smtp.corp.redhat.com (Postfix)
 id CC51FC478DE; Fri,  7 Jul 2023 16:39:17 +0000 (UTC)
Delivered-To: linux-cachefs@redhat.com
Received: from mimecast-mx02.redhat.com
 (mimecast03.extmail.prod.ext.rdu2.redhat.com [10.11.55.19])
 by smtp.corp.redhat.com (Postfix) with ESMTPS id B6CE4C09A09
 for <linux-cachefs@redhat.com>; Fri,  7 Jul 2023 16:39:17 +0000 (UTC)
Received: from us-smtp-1.mimecast.com (us-smtp-1.mimecast.com [207.211.31.81])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256
 bits)) (No client certificate requested)
 by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 17CA881DA29
 for <linux-cachefs@redhat.com>; Fri,  7 Jul 2023 16:39:17 +0000 (UTC)
Received: from mail-ot1-f52.google.com (mail-ot1-f52.google.com
 [209.85.210.52]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-335-qwhLiGlJOIakaz1AqRfq4g-1; Fri, 07 Jul 2023 12:39:05 -0400
X-MC-Unique: qwhLiGlJOIakaz1AqRfq4g-1
Received: by mail-ot1-f52.google.com with SMTP id
 46e09a7af769-6b8b8de2c6bso1785813a34.0; 
 Fri, 07 Jul 2023 09:39:05 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 b=
X-Gm-Message-State: ABy/qLYNrmMkrZWI/lw9jAVY1+fT8DJ1VtGCvfe18KLUQ68o5uZUemRp
 NlOYMP/P+OXmDBTQGOgIODCtud//rTjJ5G67
X-Google-Smtp-Source: APBJJlHT/l/Ob7ORmQyBHvvpmoKmd9F+aGnyTkOUqPlzUuMkKi6g4H0B9x+R3MSaLBeWoidELJODZA==
X-Received: by 2002:a05:6870:5b84:b0:1b0:1c15:3f16 with SMTP id
 em4-20020a0568705b8400b001b01c153f16mr7136788oab.52.1688747943359; 
 Fri, 07 Jul 2023 09:39:03 -0700 (PDT)
Received: from fedora ([121.135.181.61]) by smtp.gmail.com with ESMTPSA id
 h13-20020a17090a3d0d00b00262eb0d141esm1885157pjc.28.2023.07.07.09.38.55
...
Subject: [Linux-cachefs] [BUG mm-unstable] BUG: KASAN: use-after-free in
...
=3D=3D=3D=3D=3D=3D=3D=3D
   0:=0948 8b 45 00          =09mov    0x0(%rbp),%rax
   4:=09f6 c4 80             =09test   $0x80,%ah
   7:=0975 40                =09jne    0x49
   9:=094d 85 ed             =09test   %r13,%r13
   c:=0974 4e                =09je     0x5c
   e:=0949 8d bd b8 00 00 00 =09lea    0xb8(%r13),%rdi
  15:=09e8 61 b6 13 00       =09call   0x13b67b
  1a:=0949 8b ad b8 00 00 00 =09mov    0xb8(%r13),%rbp
  21:=0948 8d 7d 48          =09lea    0x48(%rbp),%rdi
  25:=09e8 51 b6 13 00       =09call   0x13b67b
  2a:*=0948 8b 45 48          =09mov    0x48(%rbp),%rax=09=09<-- trapping i=
nstruction
  2e:=0948 85 c0             =09test   %rax,%rax
  31:=0974 29                =09je     0x5c
  33:=0944 89 e6             =09mov    %r12d,%esi
  36:=0948 89 df             =09mov    %rbx,%rdi
  39:=095b                   =09pop    %rbx
  3a:=095d                   =09pop    %rbp
  3b:=0941 5c                =09pop    %r12
  3d:=0941 5d                =09pop    %r13
  3f:=0941                   =09rex.B

Code starting with the faulting instruction
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D
   0:=0948 8b 45 48          =09mov    0x48(%rbp),%rax
   4:=0948 85 c0             =09test   %rax,%rax
   7:=0974 29                =09je     0x32
   9:=0944 89 e6             =09mov    %r12d,%esi
   c:=0948 89 df             =09mov    %rbx,%rdi
   f:=095b                   =09pop    %rbx
  10:=095d                   =09pop    %rbp
  11:=0941 5c                =09pop    %r12
  13:=0941 5d                =09pop    %r13
  15:=0941                   =09rex.B
...
.h:700 kernel/sched/sched.h:1378 kernel/sched/core.c:5133 kernel/sched/core=
.c:5251)=20
...
.h:380 (discriminator 1) mm/page_alloc.c:3717 (discriminator 1) mm/page_all=
oc.c:3736 (discriminator 1) mm/page_alloc.c:4141 (discriminator 1))=20
...
All code
=3D=3D=3D=3D=3D=3D=3D=3D
   0:=098b 57 10             =09mov    0x10(%rdi),%edx
   3:=0931 c0                =09xor    %eax,%eax
   5:=0948 85 d2             =09test   %rdx,%rdx
   8:=0974 27                =09je     0x31
   a:=0949 8b 0f             =09mov    (%r15),%rcx
   d:=0948 3b 11             =09cmp    (%rcx),%rdx
  10:=0977 1f                =09ja     0x31
  12:=09e9 d1 00 00 00       =09jmp    0xe8
  17:=098a 0d 6f 35 4f 00    =09mov    0x4f356f(%rip),%cl        # 0x4f358c
  1d:=0984 c9                =09test   %cl,%cl
  1f:=090f 84 c3 00 00 00    =09je     0xe8
  25:=0948 85 d2             =09test   %rdx,%rdx
  28:=0975 17                =09jne    0x41
  2a:*=0941 88 04 06          =09mov    %al,(%r14,%rax,1)=09=09<-- trapping=
 instruction
  2e:=094c 01 e0             =09add    %r12,%rax
  31:=0949 8d 34 06          =09lea    (%r14,%rax,1),%rsi
  35:=0948 89 74 24 08       =09mov    %rsi,0x8(%rsp)
  3a:=094c 39 d0             =09cmp    %r10,%rax
  3d:=0972 d8                =09jb     0x17
  3f:=09eb                   =09.byte 0xeb

Code starting with the faulting instruction
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D
   0:=0941 88 04 06          =09mov    %al,(%r14,%rax,1)
   4:=094c 01 e0             =09add    %r12,%rax
   7:=0949 8d 34 06          =09lea    (%r14,%rax,1),%rsi
   b:=0948 89 74 24 08       =09mov    %rsi,0x8(%rsp)
  10:=094c 39 d0             =09cmp    %r10,%rax
  13:=0972 d8                =09jb     0xffffffffffffffed
  15:=09eb                   =09.byte 0xeb
...
All code
=3D=3D=3D=3D=3D=3D=3D=3D
   0:=09bb d8 09 00 00       =09mov    $0x9d8,%ebx
   5:=0931 f6                =09xor    %esi,%esi
   7:=09e8 0d bf ff ff       =09call   0xffffffffffffbf19
   c:=09e9 2f fc ff ff       =09jmp    0xfffffffffffffc40
  11:=090f 0b                =09ud2
  13:=09e9 67 f2 ff ff       =09jmp    0xfffffffffffff27f
  18:=094c 89 e6             =09mov    %r12,%rsi
  1b:=09bf 05 06 00 00       =09mov    $0x605,%edi
  20:=09e8 14 9e 01 00       =09call   0x19e39
  25:=09e9 f8 f3 ff ff       =09jmp    0xfffffffffffff422
  2a:*=090f 0b                =09ud2=09=09<-- trapping instruction
  2c:=09e9 cb f2 ff ff       =09jmp    0xfffffffffffff2fc
  31:=0948 89 df             =09mov    %rbx,%rdi
  34:=09e8 20 86 1b 00       =09call   0x1b8659
  39:=09e9 9c f5 ff ff       =09jmp    0xfffffffffffff5da
  3e:=0948                   =09rex.W
  3f:=0989                   =09.byte 0x89

Code starting with the faulting instruction
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D
   0:=090f 0b                =09ud2
   2:=09e9 cb f2 ff ff       =09jmp    0xfffffffffffff2d2
   7:=0948 89 df             =09mov    %rbx,%rdi
   a:=09e8 20 86 1b 00       =09call   0x1b862f
   f:=09e9 9c f5 ff ff       =09jmp    0xfffffffffffff5b0
  14:=0948                   =09rex.W
  15:=0989                   =09.byte 0x89
...
All code
=3D=3D=3D=3D=3D=3D=3D=3D
   0:=0939 04 24             =09cmp    %eax,(%rsp)
   3:=090f 84 d0 00 00 00    =09je     0xd9
   9:=094d 8b 65 18          =09mov    0x18(%r13),%r12
   d:=0948 8b 7c 24 10       =09mov    0x10(%rsp),%rdi
  12:=0948 8b 6c 24 48       =09mov    0x48(%rsp),%rbp
  17:=09e8 90 b4 a7 ff       =09call   0xffffffffffa7b4ac
  1c:=0949 8d 7c 24 08       =09lea    0x8(%r12),%rdi
  21:=0949 8b 5d 20          =09mov    0x20(%r13),%rbx
  25:=09e8 32 b5 a7 ff       =09call   0xffffffffffa7b55c
  2a:*=094d 89 74 24 08       =09mov    %r14,0x8(%r12)=09=09<-- trapping in=
struction
  2f:=0948 89 df             =09mov    %rbx,%rdi
  32:=094c 89 64 24 48       =09mov    %r12,0x48(%rsp)
  37:=09e8 20 b5 a7 ff       =09call   0xffffffffffa7b55c
  3c:=0948 89 2b             =09mov    %rbp,(%rbx)
  3f:=0948                   =09rex.W

Code starting with the faulting instruction
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D
   0:=094d 89 74 24 08       =09mov    %r14,0x8(%r12)
   5:=0948 89 df             =09mov    %rbx,%rdi
   8:=094c 89 64 24 48       =09mov    %r12,0x48(%rsp)
   d:=09e8 20 b5 a7 ff       =09call   0xffffffffffa7b532
  12:=0948 89 2b             =09mov    %rbp,(%rbx)
  15:=0948                   =09rex.W
...
.c:1315 kernel/locking/rwsem.c:1574)=20
...
[   12.986660] PGD b059067 P4D b059067=20=0D
[   12.986915] ? report_bug (lib/bug.c:180 lib/bug.c:219)=20
[   12.987286] PUD b05a063 PMD 800000000a8001e1=20=0D
...
[   13.367919] PGD b059067 P4D b059067 PUD b05a063=20=0D
...
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D
  ...
  13:=0972 d8                =09jb     0xffffffffffffffed
  15:=09eb                   =09.byte 0xeb
[   13.368570] PMD 800000000a8001e1=20=0D
...
.c:1347 (discriminator 5) kernel/locking/rwsem.c:1616 (discriminator 5))=20
...
=3D=3D=3D=3D=3D=3D=3D=3D
   0:=0974 21                =09je     0x23
   2:=0948 8d 44 24 08       =09lea    0x8(%rsp),%rax
   7:=09c7 44 24 b8 20 00 00 =09movl   $0x20,-0x48(%rsp)
   e:=0900=20
   f:=094c 8b 44 24 f0       =09mov    -0x10(%rsp),%r8
  14:=0948 89 44 24 c0       =09mov    %rax,-0x40(%rsp)
  19:=0948 8d 44 24 d0       =09lea    -0x30(%rsp),%rax
  1e:=0948 89 44 24 c8       =09mov    %rax,-0x38(%rsp)
  23:=09b8 19 00 00 00       =09mov    $0x19,%eax
  28:=090f 05                =09syscall
  2a:*=0948 3d 00 f0 ff ff    =09cmp    $0xfffffffffffff000,%rax=09=09<-- t=
rapping instruction
  30:=0976 10                =09jbe    0x42
  32:=0948 8b 15 dc ed 0a 00 =09mov    0xaeddc(%rip),%rdx        # 0xaee15
  39:=09f7 d8                =09neg    %eax
  3b:=0964 89 02             =09mov    %eax,%fs:(%rdx)
  3e:=0948                   =09rex.W
  3f:=0983                   =09.byte 0x83

Code starting with the faulting instruction
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D
   0:=0948 3d 00 f0 ff ff    =09cmp    $0xfffffffffffff000,%rax
   6:=0976 10                =09jbe    0x18
   8:=0948 8b 15 dc ed 0a 00 =09mov    0xaeddc(%rip),%rdx        # 0xaedeb
   f:=09f7 d8                =09neg    %eax
  11:=0964 89 02             =09mov    %eax,%fs:(%rdx)
  14:=0948                   =09rex.W
  15:=0983                   =09.byte 0x83
...
[   13.820245] PGD b059067 P4D b059067 PUD b05a063 PMD 800000000a8001e1=20=
=0D
...
All code
=3D=3D=3D=3D=3D=3D=3D=3D
   0:=0948 8b 6c 24 48       =09mov    0x48(%rsp),%rbp
   5:=09e8 90 b4 a7 ff       =09call   0xffffffffffa7b49a
   a:=0949 8d 7c 24 08       =09lea    0x8(%r12),%rdi
   f:=0949 8b 5d 20          =09mov    0x20(%r13),%rbx
  13:=09e8 32 b5 a7 ff       =09call   0xffffffffffa7b54a
  18:=094d 89 74 24 08       =09mov    %r14,0x8(%r12)
  1d:=0948 89 df             =09mov    %rbx,%rdi
  20:=094c 89 64 24 48       =09mov    %r12,0x48(%rsp)
  25:=09e8 20 b5 a7 ff       =09call   0xffffffffffa7b54a
  2a:*=0948 89 2b             =09mov    %rbp,(%rbx)=09=09<-- trapping instr=
uction
  2d:=0948 8d 7d 08          =09lea    0x8(%rbp),%rdi
  31:=09e8 14 b5 a7 ff       =09call   0xffffffffffa7b54a
  36:=0948 8b 04 24          =09mov    (%rsp),%rax
  3a:=0948 89 5d 08          =09mov    %rbx,0x8(%rbp)
  3e:=0949                   =09rex.WB
  3f:=0989                   =09.byte 0x89
...
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D
   0:=0948 89 2b             =09mov    %rbp,(%rbx)
   3:=0948 8d 7d 08          =09lea    0x8(%rbp),%rdi
   7:=09e8 14 b5 a7 ff       =09call   0xffffffffffa7b520
   c:=0948 8b 04 24          =09mov    (%rsp),%rax
  10:=0948 89 5d 08          =09mov    %rbx,0x8(%rbp)
  14:=0949                   =09rex.WB
  15:=0989                   =09.byte 0x89
...
=3D=3D=3D=3D=3D=3D=3D=3D
   ...
   6:=0990                   =09nop
   7:=0990                   =09nop
   8:=09f3 0f 1e fa          =09endbr64
   c:=090f 1f 44 00 00       =09nopl   0x0(%rax,%rax,1)
  11:=0941 57                =09push   %r15
  13:=0941 56                =09push   %r14
  15:=0941 55                =09push   %r13
  17:=0949 89 f5             =09mov    %rsi,%r13
  1a:=0941 54                =09push   %r12
  1c:=0955                   =09push   %rbp
  1d:=0953                   =09push   %rbx
  1e:=0948 89 fb             =09mov    %rdi,%rbx
  21:=0948 83 ec 30          =09sub    $0x30,%rsp
  25:=09e8 9e d3 0b 00       =09call   0xbd3c8
  2a:*=0948 8b 03             =09mov    (%rbx),%rax=09=09<-- trapping instr=
uction
  2d:=0948 83 f8 ff          =09cmp    $0xffffffffffffffff,%rax
  31:=090f 84 b2 03 00 00    =09je     0x3e9
  37:=094c 8d 7b 08          =09lea    0x8(%rbx),%r15
  3b:=094c 89 ff             =09mov    %r15,%rdi
  3e:=09e8                   =09.byte 0xe8
  3f:=0985                   =09.byte 0x85

Code starting with the faulting instruction
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D
   0:=0948 8b 03             =09mov    (%rbx),%rax
   3:=0948 83 f8 ff          =09cmp    $0xffffffffffffffff,%rax
   7:=090f 84 b2 03 00 00    =09je     0x3bf
   d:=094c 8d 7b 08          =09lea    0x8(%rbx),%r15
  11:=094c 89 ff             =09mov    %r15,%rdi
  14:=09e8                   =09.byte 0xe8
  15:=0985                   =09.byte 0x85
