...
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [63.128.21.124])
	by mail.lfdr.de (Postfix) with ESMTP id DD874322873
	for <lists+linux-cachefs@lfdr.de>; Tue, 23 Feb 2021 11:01:58 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1614074518;
	...
	bh=F1u6oWYOzwt40BB0+AR1DHvoYIMm/oRrCOAkF/wXwLo=;
	b=Zhd5tYSx6ZD236oh8L7XzdRbr6acR9L3VN3epdGSVS3qYcHONCk+7mXUA+ZeL+/5XWYAaD
	p+AbFY4qT9x6bEc6GAdYMb8aHXADhmO9+uA8uDEiU3t6ILJU8opWibIVVp79HdL/oD4XiP
	dtFkdm+4fffLTiyF3JZanzQZa/YJ6P8=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-398-A5cGOdupP5yoZrzIysdL7w-1; Tue, 23 Feb 2021 04:59:48 -0500
X-MC-Unique: A5cGOdupP5yoZrzIysdL7w-1
Received: from smtp.corp.redhat.com (int-mx04.intmail.prod.int.phx2.redhat.com [10.5.11.14])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 9632B801981;
	Tue, 23 Feb 2021 09:59:38 +0000 (UTC)
Received: from colo-mx.corp.redhat.com (colo-mx01.intmail.prod.int.phx2.redhat.com [10.5.11.20])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id 862145D9DC;
	Tue, 23 Feb 2021 09:59:38 +0000 (UTC)
Received: from lists01.pubmisc.prod.ext.phx2.redhat.com (lists01.pubmisc.prod.ext.phx2.redhat.com [10.5.19.33])
	by colo-mx.corp.redhat.com (Postfix) with ESMTP id 72D8318077BA;
	Tue, 23 Feb 2021 09:59:38 +0000 (UTC)
Received: from smtp.corp.redhat.com (int-mx02.intmail.prod.int.phx2.redhat.com
	[10.5.11.12])
	by lists01.pubmisc.prod.ext.phx2.redhat.com (8.13.8/8.13.8) with ESMTP
	id 11IE2ket027260 for <linux-cachefs@listman.util.phx.redhat.com>;
	Thu, 18 Feb 2021 09:02:46 -0500
Received: by smtp.corp.redhat.com (Postfix)
	id 2DE4760C6F; Thu, 18 Feb 2021 14:02:46 +0000 (UTC)
...
X-MIME-Autoconverted: from quoted-printable to 8bit by
	lists01.pubmisc.prod.ext.phx2.redhat.com id 11IE2ket027260
...
Subject: [Linux-cachefs] [PATCH 34/33] netfs: Pass flag rather than use
	in_softirq()
